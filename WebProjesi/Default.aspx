<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebProjesi.Default" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <!-- Duruma Göre Eklenecekler -->
    <link rel="stylesheet" href="/Resources/css/timeline.min.css"/>
    <link rel="stylesheet" href="/Resources/css/prettyPhoto.css"/>
    <link rel="stylesheet" href="/Resources/css/animate.css"/>
    <link rel="stylesheet" href="/Resources/css/pr_loading.css"/>
    <link rel="stylesheet" href="/Resources/css/animate.min.css"/>
    <link rel="stylesheet" href="/Resources/css/owl.carousel.css"/>
    <link rel="stylesheet" href="/Resources/css/bootstrap-touch-slider.css"/>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link" href="about.html">Galeri</a></li>
						<li class="nav-item"><a class="nav-link" href="features.html">Hakkımızda </a></li>
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="dropdown-a" data-toggle="dropdown">İletişim </a>
						...
						<li class="nav-item"><a class="nav-link" href="domain.html">Bilgi</a></li>
						<li class="nav-item"><a class="nav-link" href="pricing.html">Değer Yok</a></li>
						<li class="nav-item"><a class="nav-link" href="contact.html">Değer Yok</a></li>
					</ul>
